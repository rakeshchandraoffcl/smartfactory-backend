...
export const userSupplierSignUpValidation = celebrate({
  body: Joi.object({
    user: Joi.object({
    ...
    company: Joi.object({
      ...
      businessNumber: Joi.alternatives().try(Joi.string(), Joi.number()).required(),
      ...
      corpCode: Joi.string().allow(null).optional(),
